    ...
    <>
      <FeedContainer>
        ...
        {Posts?.map((Post) => (
          <FeedCard>
            <FeedCardLogo>
              <FeedCardLogoProfileIcon src={Post.UserImg} />
            </FeedCardLogo>
            <FeedCardSection>
              <FeedCardSectionUserData>
                <FeedCardSectionUsername>
                ...
                <FeedCardSectionUserTag>@{Post.UserTag}</FeedCardSectionUserTag>
                <FeedCardSectionPostedTime>
                  {"- " + Post.PostDate}
                </FeedCardSectionPostedTime>
              </FeedCardSectionUserData>
              <FeedCardSectionPost>
                ...
                <FeedCardSectionPostImage src={Post.Img} />
                <FeedCardSectionPostAction>
                  <FeedCardSectionPostActionItem>
                    <FeedCardSectionPostActionItemIcon
                      src={
